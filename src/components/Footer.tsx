        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <img
              src={logoFooter}
              alt="Vital Home Pros"
              className="w-48 mb-6 hover:scale-105 transition-transform duration-300"
            />
            <p className="text-base font-bold text-white mb-3">Your Trusted Heating & Cooling Professionals</p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-base">
              <li>
                <a
                  href="#about"
                  className="hover:text-secondary transition-all duration-300 hover:translate-x-1 inline-block font-medium"
                >
                  About Us
                </a>
              </li>
            ...
            <div className="space-y-4 text-base">
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  ...
                  className="hover:text-secondary transition-colors font-medium mt-2"
                >
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/90 font-medium mt-2 leading-relaxed">
                  Serving Kansas City, KS • Kansas City, MO • Overland Park • Olathe • Lenexa • Shawnee • Lee's Summit •
