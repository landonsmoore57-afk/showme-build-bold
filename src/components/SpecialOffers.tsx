    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-slide-up">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-primary mb-6">Special Offers Just for You</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
          {offers.map((offer, index) => (
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-6 border-t border-primary/10 pt-4">{offer.details}</p>
        ...
        <div className="bg-primary text-white p-8 md:p-12 rounded-lg border-[3px] border-primary shadow-card max-w-4xl mx-auto text-center">
          <h3 className="text-2xl md:text-3xl font-black mb-4">Flexible Financing Available</h3>
