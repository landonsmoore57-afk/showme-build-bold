...
export const BRAND = {
  ...
  tagline: "Your Trusted Heating & Cooling Professionals",
  yearsInBusiness: "15",
};
...
export const kcMetroCities: CityData[] = [
  // Missouri - Jackson County
  {
    ...
    slug: "kansas-city",
    priority: 1,
    neighborhoods: ["Downtown", "Crossroads", "Westport", "Brookside", "Waldo", "Northland"],
  ...
  // Kansas - Wyandotte County
  {
    ...
    slug: "kansas-city",
    priority: 1,
    neighborhoods: ["Piper", "Turner", "Rosedale", "Argentine", "Armourdale", "Strawberry Hill"],
  },
  ...
  "ac-repair": [
    {
      ...
      answer:
        "We offer same-day service for most AC repairs. Our technicians arrive fully equipped to diagnose and fix common issues on the first visit.",
    },
    {
      question: "What causes an AC to stop cooling?",
      answer:
        "Common causes include low refrigerant, dirty filters, frozen coils, or capacitor failure. Our technicians will diagnose the exact issue and provide upfront pricing before any work begins.",
    },
    {
      question: "Do you offer emergency AC repair?",
      answer:
        "Yes! We provide 24/7 emergency service because we know Missouri summers don't wait. Call us anytime for urgent AC repairs.",
    },
  ],
  "ac-installation": [
    {
      ...
      answer:
        "Most installations are completed in one day. Complex installations may take longer, but we'll give you an accurate timeline during the estimate.",
    },
    {
      question: "What size AC unit do I need?",
      answer:
        "Our technicians perform a detailed load calculation based on your home's size, insulation, and layout to ensure you get the perfectly sized system for maximum efficiency.",
    },
    {
      question: "Are there rebates available?",
      answer:
        "Yes! Many utility companies offer rebates on high-efficiency systems. We'll help you identify and apply for all available rebates and financing options.",
    },
  ],
  "furnace-repair": [
    {
      ...
      answer:
        "Some sounds are normal, but banging, screeching, or rumbling often indicates a problem. We'll inspect your furnace and identify any issues before they become major repairs.",
    },
    {
      question: "How often should I service my furnace?",
      answer:
        "Annual maintenance before heating season is recommended. Regular tune-ups prevent breakdowns, improve efficiency, and extend your furnace's lifespan.",
    },
    {
      question: "Why isn't my furnace producing heat?",
      answer:
        "Common causes include thermostat issues, ignition problems, or a faulty blower motor. Our technicians will quickly diagnose and repair the problem.",
    },
  ],
  "furnace-installation": [
    {
      ...
      answer:
        "If your furnace is over 15 years old, requires frequent repairs, or your energy bills are rising, replacement is often more cost-effective than continued repairs.",
    },
    {
      question: "What type of furnace is best?",
      answer:
        "We'll recommend the best system based on your home, budget, and efficiency goals. Options include gas, electric, and high-efficiency models with variable-speed technology.",
    },
    {
  ...
  "hvac-maintenance": [
    {
      ...
      answer:
        "We recommend twice-yearly service: once before cooling season and once before heating season. This prevents breakdowns and keeps your system running efficiently.",
    },
    {
      question: "What's included in a maintenance visit?",
      answer:
        "Our comprehensive tune-up includes filter replacement, coil cleaning, refrigerant check, electrical connections inspection, and performance testing.",
    },
    {
      question: "Will maintenance save me money?",
      answer:
        "Absolutely! Regular maintenance improves efficiency (lowering energy bills), prevents costly repairs, and extends your equipment's lifespan.",
    },
  ],
  "indoor-air-quality": [
    {
      ...
      answer:
        "Solutions include air purifiers, UV lights, humidifiers/dehumidifiers, and regular filter changes. We'll assess your home and recommend the best options.",
    },
    {
      question: "What are signs of poor air quality?",
      answer:
        "Excessive dust, odors, respiratory irritation, humidity problems, and frequent allergy symptoms all indicate poor indoor air quality.",
    },
    {
      question: "Do air purifiers really work?",
      answer:
        "Yes! Modern whole-home air purifiers remove up to 99.97% of airborne particles, including allergens, bacteria, and viruses, significantly improving indoor air quality.",
    },
  ],
};
